...
import com.example.passport.databinding.FragmentGlavniBinding
...
class GlavniFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentGlavniBinding.inflate(inflater,container,false)
        ...
        binding.allCitizens.setOnClickListener {
            findNavController().navigate(R.id.citizensFragment)
        }
